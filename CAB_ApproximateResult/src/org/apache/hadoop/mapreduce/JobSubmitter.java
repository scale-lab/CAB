...
class JobSubmitter {
    ...
    JobStatus submitJobInternal(Job job, Cluster cluster)
        ...
        //CAB Added
		//Writing the minimum number of required tasks, as well as 
        File file = new File("/usr/local/hadoop/ApproxCapping/" +job.getJobID().toString() + ".txt");
        if (file.exists()) {
            file.delete();
        }
        ...
        try (FileWriter fw = new FileWriter(file.getAbsoluteFile())) {
            ...
            bw.write(Integer.toString(job.getDeadline()) + "\n");
            bw.write(Integer.toString(job.getDesiredMap()) + "\n");
