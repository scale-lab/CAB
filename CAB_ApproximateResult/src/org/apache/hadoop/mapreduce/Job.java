...
public class Job extends JobContextImpl implements JobContext {
	...
	//Adding minimum required number of tasks to meet QoR and deadline to job
    public int numberofDesiredMaptasks = 0;
    public int desiredDeadline = 0;

    public void setDesiredMap(int number) {
        numberofDesiredMaptasks = number;
    }

    public int getDesiredMap() {
        return numberofDesiredMaptasks;
    }
