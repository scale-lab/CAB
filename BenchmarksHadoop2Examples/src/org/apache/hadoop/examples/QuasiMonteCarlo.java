...
public class QuasiMonteCarlo extends Configured implements Tool {
   ...
   */
  public static BigDecimal estimatePi(int deadline, int desiredMap,int numMaps, long numPoints,
  ...
  public int run(String[] args) throws Exception {
    ...
    //Morteza
    final int desiredDeadline = Integer.parseInt(args[0]);
    final int desiredMap = Integer.parseInt(args[1]);
    
    final int nMaps = Integer.parseInt(args[2]);
    final long nSamples = Long.parseLong(args[3]);
    ...
    File file2 = new File("/usr/local/hadoop/Pi_" + desiredMap+".txt");
        ...
        BufferedWriter bw2 = new BufferedWriter(fw2);
            bw2.write("Estimated value of Pi is "
        + estimatePi(desiredDeadline, desiredMap, nMaps, nSamples, tmpDir, getConf()));
